...
///
pub fn clamp2(year_input: &str, max_year: u32, min_year: u32) -> (u32, String) {
...
pub mod clamp_test {
    ...
    fn clamp_test() {
        ...
        assert_eq!(parsed_num(1984), clamp2("1984", max, min));
        assert_eq!(parsed_num(2025), clamp2("2025", max, min));
        assert_eq!(parsed_num(2200), clamp2("2200", max, min));
        assert_eq!(parsed_num(1980), clamp2("1980", max, min));
        assert_eq!(parsed_num(1980), clamp2("1979", max, min));
        assert_eq!(parsed_num(1999), clamp2("1999", max, min));
        assert_eq!(parsed_num(2200), clamp2("2540", max, min));
        assert_eq!(parsed_num(2200), clamp2("99999", max, min));
        assert_eq!(parsed_num(1980), clamp2("193", max, min));
        assert_eq!(parsed_num(1980), clamp2("209", max, min));
        
        println!("{:?} , {:?}", parsed_num(1984), clamp2("1984", max, min));
        println!("{:?} , {:?}", parsed_num(2025), clamp2("2025", max, min));
        println!("{:?} , {:?}", parsed_num(2200), clamp2("2200", max, min));
        println!("{:?} , {:?}", parsed_num(1980), clamp2("1980", max, min));
        println!("{:?} , {:?}", parsed_num(1980), clamp2("1979", max, min));
        println!("{:?} , {:?}", parsed_num(1999), clamp2("1999", max, min));
        println!("{:?} , {:?}", parsed_num(2200), clamp2("2540", max, min));
        println!("{:?} , {:?}", parsed_num(2200), clamp2("99999", max, min));
        println!("{:?} , {:?}", parsed_num(198), clamp2("193", max, min));
        println!("{:?} , {:?}", parsed_num(209), clamp2("209", max, min));
