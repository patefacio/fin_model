        ...
        .enumerate()
    {
        ...
        if !inside_upper_bound {
            if input_char_digit < digit_from_max {
                ...
                return (max_year/(u32::pow(10, (num_digits_in_range-size) as u32)), max_year.to_string()[0..size].to_string());
        ...
        if !inside_lower_bound {
            ...
            if input_char_digit > digit_from_min {
                ...
                return (min_year/(u32::pow(10, (num_digits_in_range-size) as u32)), min_year.to_string()[0..size].to_string());
