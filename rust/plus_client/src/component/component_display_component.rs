...
#[component]
pub fn ComponentDisplayComponent() -> impl IntoView {
    ...
    let (read_count, write_count) = create_signal(0);
    let (last_update, set_last_update) = create_signal(String::default());
    ...
    view! {
        <div class="cdc">
            ...
            <Show when=move || (read_count.get() % 2) == 0 fallback=|| "Nothing">
                <DisposeTest/>
            </Show>
            <p>
                <hr/>
