...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tonic_build::configure()
        ...
        .type_attribute("Currency", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("AccountType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("BasicAllocationType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("DistributionInstrument", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("DistributionInstrumentType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("ForecastTaxTreatment", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("FlowDirection", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("PersonType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("ForecastYearMarkerType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("TaxUsFilingStatus", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("TaxUsCategory", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("TaxTreatment", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("ForecastSortCriteria", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("Country", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("StateOfResidence", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("NamedRateCurve", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("WorthType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("HoldingType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
        .type_attribute("FlowType", "#[derive(Serialize, Deserialize, EnumVariantNames, FromRepr, EnumIter)]")
