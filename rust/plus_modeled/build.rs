...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    tonic_build::configure()
        ...
        .type_attribute(
            "DossierCorrelationEntry",
            "#[derive(Serialize, Deserialize)]",
        )
        .type_attribute(
            "DossierCorrelationMatrix",
            "#[derive(Serialize, Deserialize)]",
        )
        .type_attribute(
            "PeriodBalance",
        ...
        .type_attribute(
            "SystemCorrelationEntry",
            "#[derive(Serialize, Deserialize)]",
        )
        .type_attribute(
            "SystemCorrelationMatrix",
            "#[derive(Serialize, Deserialize)]",
        )
        .type_attribute("MarketAssumptions", "#[derive(Serialize, Deserialize)]")
        .type_attribute(
            "OutlookMarketAssumptions",
            "#[derive(Serialize, Deserialize)]",
        )
        ...
        .type_attribute(
            "DistributionInstrument",
            "#[derive(Serialize, Deserialize, EnumVariantNames, EnumIter)]",
        )
        .type_attribute(
            "DistributionInstrumentType",
            "#[derive(Serialize, Deserialize, EnumVariantNames, EnumIter)]",
        )
        .type_attribute(
            "ForecastTaxTreatment",
            "#[derive(Serialize, Deserialize, EnumVariantNames, EnumIter)]",
        )
        .type_attribute(
            "FlowDirection",
