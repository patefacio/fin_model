...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tonic_build::configure()
        ...
        .type_attribute("Currency", "#[derive(Serialize, Deserialize)]")
        .type_attribute("AccountType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("BasicAllocationType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("DistributionInstrument", "#[derive(Serialize, Deserialize)]")
        .type_attribute("DistributionInstrumentType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("ForecastTaxTreatment", "#[derive(Serialize, Deserialize)]")
        .type_attribute("FlowDirection", "#[derive(Serialize, Deserialize)]")
        .type_attribute("PersonType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("ForecastYearMarkerType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("TaxUsFilingStatus", "#[derive(Serialize, Deserialize)]")
        .type_attribute("TaxUsCategory", "#[derive(Serialize, Deserialize)]")
        .type_attribute("TaxTreatment", "#[derive(Serialize, Deserialize)]")
        .type_attribute("ForecastSortCriteria", "#[derive(Serialize, Deserialize)]")
        .type_attribute("Country", "#[derive(Serialize, Deserialize)]")
        .type_attribute("StateOfResidence", "#[derive(Serialize, Deserialize)]")
        .type_attribute("NamedRateCurve", "#[derive(Serialize, Deserialize)]")
        .type_attribute("WorthType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("HoldingType", "#[derive(Serialize, Deserialize)]")
        .type_attribute("FlowType", "#[derive(Serialize, Deserialize)]")
